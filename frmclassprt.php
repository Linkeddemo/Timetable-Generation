    ...
    <div id="slider">
        ...
        <div id="header_wrapper">
            <div id="header">
                ...
                <a href="#home"><h1></h1>
                <h1>Sivkamal Ded college,Umarkhed</h1>
                </a> 
		</div>
        ...
        <div id="menu_wrapper">
            <div id="menu">
                <ul class="navigation">
                    ...
                    <li><a href="./frmreport.html">Report<span class="ui_icon services"></span></a></li>
...
<form = action="dbclass_save.php" method="post" id="frm_class" name="frm_class">
        ...
        <div id="content">
        	<div class="scroll">
			 ...
			 <div class="title">
				<h2><center> 
				  <p class="style4">Class room wise Timetable</p>
				  </center> </h2>
        ...
        <div id="footer">
        	        	Copyright © 2048 <a >Shivkamal Eed College,Umarkhed </a> | Designed by <a> JJM CSE STUDENT</a>
        </div>
