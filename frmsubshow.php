...
//	mysql_select_db($data->db, $con);
		...
		$sql="Select * From table_sub Where sub_code='". $sub_code[0] ."'";
		$res=mysql_query($sql);
...
<form action="frmsubjectupdate.php" method="post" id="frm_Home" name="frm_Home">
        ...
        <div id="content">
			...
			<td width="135" height="78" align="right" valign="middle"> Subject code</td>
