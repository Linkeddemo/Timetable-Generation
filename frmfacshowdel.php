...
<form action="dbfaculty_delete.php" method="post" id="frm_Home" name="frm_Home">
        ...
        <div id="content">
			  ...
			  <div class="title">
				<h2><center> 
				  <p class="style4">&nbsp;</p>
				  <p class="style4"> Delete Faculty information</p>
				</center> 
				</h2>
			...
			<td width="135" height="78" align="right" valign="middle"> Faculty Name</td>
                        ...
                        <?php
							$con = mysql_connect("localhost","timetablega","timetablega");
								...
								else
								{
									...
									$sql="Select fac_fname,fac_mname,fac_lname,fac_id From Table_faculty ";
									$result=mysql_query($sql);
									while($row=mysql_fetch_array($result,MYSQL_NUM))
									{
										$fnm=$row[3]."-".$row[0]." ".$row[1] ." ".$row[2];
				...
				<td width="100" align="center" valign="middle" >
					<input type="submit" name="cmdSumit" id="cmdSumit" value="Delete"  />
			  </td>
