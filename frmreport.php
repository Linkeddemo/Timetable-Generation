...
<form = action="dblogin.php" method="post" id="frm_Home" name="frm_Home">
        ...
        <div id="content">
            ...
            <tr><td><a href="./displayfaculty.php">Faculty Report</a></td></tr>
            <tr><td><a href="./displaysubject.php">Subject Report</a></td></tr>
		    <tr><td><a href="./displayclass.php">Class Report</a></td></tr>
			<tr><td><a href="./displayallocation.php">Allocation Report</a></td></tr>
            <tr><td><a href="./displaytimeslot.php">Time slot Report</a></td></tr>
			</table>
                	</div>
