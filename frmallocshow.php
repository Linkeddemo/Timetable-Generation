...
//	mysql_select_db($data->db, $con);
		...
		$sql="Select * From table_alloc Where alloc_id'". $alloc_id[0] ."'";
		$res=mysql_query($sql);
...
<form action="frmAllocationupdate.php" method="post" id="frm_Home" name="frm_Home">
        ...
        <div id="content">
			  ...
			  <div class="title">
				<h2><center> 
				  <p class="style4">&nbsp; </p>
				  <p class="style4">Update Alloction Information</p>
				</center> 
				</h2>
